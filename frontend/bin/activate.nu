...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/goncaloazevedo/Year2/SEG/python/hp-spending-tracker/frontend'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/goncaloazevedo/Year2/SEG/python/hp-spending-tracker/frontend/bin/deactivate.nu'
