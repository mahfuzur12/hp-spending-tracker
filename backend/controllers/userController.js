...
exports.signupUser = async (req, res) => {
    try {
        ...
        const url = `https://hp-spending-tracker.netlify.app/api/auth/activate/${activation_token}`;
...
exports.forgotPassword = async (req, res) => {
    try {
        ...
        const url = `https://hp-spending-tracker.netlify.app/auth/reset-password/${ac_token}`;
